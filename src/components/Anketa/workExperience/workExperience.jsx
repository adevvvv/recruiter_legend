        ...
        <div>
            <div style={{display: 'flex', justifyContent: 'space-between'}}>
                <div style={{display: 'flex', flexDirection: 'column'}}>
                    ...
                    <input onBlur={handleChange} style={{width: '296px'}} name={'nameCompany'} type="text"/>
                </div>
                <div style={{display: 'flex', gap: '10px'}}>
                    ...
                    <div style={{display: 'flex', alignItems: 'center'}}>
                        <input onChange={handleChange} name={'currentlyWorking'} type="checkbox"/>
            ...
            <div style={{display: 'flex', flexDirection: 'column', textAlign: 'left'}}>
                ...
                <input onBlur={handleChange} style={{width: '773px', height: '31px'}} name={'post'} type="text"/>

                <label htmlFor="responsibilities">Обязанности </label>
                <input onBlur={handleChange} style={{width: '773px', height: '67px'}} name={'responsibilities'} type="text"/>
