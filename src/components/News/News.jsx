...
const News = ({isRole}) => {
    ...
    const [news, setNews] = useState([
        ...
        },
        {
            ...
            "title": "Apple погружается в пространственное аудио и ИИ, а аккумулятор в линзе заряжается от слез: дайджест главных новостей"
        },
        {
            ...
            "title": "Разработчики EMXControls поделились опытом миграции большого приложения с WinForms на Avalonia"
        },
        {
            ...
            "title": "Slack начал рассылку предупреждений пользователям из РФ о приостановке их учетных записей"
        },
        {
            ...
            "title": "Microsoft удалила ранее установленный на ПК с Windows «безобидный» Copilot"
        },
        {
        ...
        },
        {
            ...
            "title": "Китайская таможня задержала контрабандистку с 350 картриджами для Nintendo Switch в пышном бюстгальтере"
        },
        {
            ...
            "title": "Учёные подтвердили, что вращение внутреннего ядра Земли действительно замедляется"
        }
    ]);
